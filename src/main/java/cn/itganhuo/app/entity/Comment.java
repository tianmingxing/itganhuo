...
public class Comment implements Serializable {
  ...
  public String toString() {
    return "Comment [id=" + id + ", userId=" + userId + ", type=" + type + ", pid=" + pid
        + ", articleId=" + articleId + ", content=" + content + ", postDate=" + postDate
        + ", praiseNum=" + praiseNum + ", trampleNum=" + trampleNum + ", operationType=" + operationType
        + ", user=" + user + ", replys=" + replys + "]";
  }
