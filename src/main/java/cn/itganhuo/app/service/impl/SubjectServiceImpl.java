...
/**
 * @author 深圳-小兴(504487927) 2014年9月30日
 * @version 1.0
 */
@Service
public class SubjectServiceImpl implements SubjectService {
  ...
  @Autowired
  public void setSubjectMapper(LabelDao labelDao) {
   ...
   * (non-Javadoc)
   * 
   * @see cn.itganhuo.core.service.SubjectService#saveSubject(cn.itganhuo.core. model.SubjectModel)
   */
  public boolean insertSubject(Label label) {
   ...
   * (non-Javadoc)
   * 
   * @see cn.itganhuo.core.service.SubjectService#delSubjectById(java.lang.String)
   */
  public boolean delSubjectById(String id) {
   ...
   * (non-Javadoc)
   * 
   * @see cn.itganhuo.core.service.SubjectService#modSubjectById(cn.itganhuo.core
   * .model.SubjectModel)
   */
  public int updateSubjectById(Label label) {
    if (label == null || !StringUtil.hasText(label.getName())) {
      return 0;
    }
   ...
   * (non-Javadoc)
   * 
   * @see cn.itganhuo.core.service.SubjectService#getSubjectByCondition(cn.itganhuo
   * .core.model.SubjectModel)
   */
  public List<Label> getSubjectByCondition(Label label) {
    return labelDao.getSubjectByCondition(label);
  }
