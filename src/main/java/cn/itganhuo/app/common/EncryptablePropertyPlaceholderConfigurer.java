...
public class EncryptablePropertyPlaceholderConfigurer extends PropertyPlaceholderConfigurer {
	...
	private final static Logger log = LogManager.getLogger(EncryptablePropertyPlaceholderConfigurer.class.getName());
	...
	protected void processProperties(ConfigurableListableBeanFactory beanFactory, Properties props) throws BeansException {
		try {
			...
			if (DriverClassName != null) {
				props.setProperty("jdbc.driverClassName", new String(Aes.decrypt(Aes.parseHexStr2Byte(DriverClassName), key)));
			}
